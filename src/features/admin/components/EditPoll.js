...
import { editPoll } from "../../../lib/redux/slices/polls/poll-slice";
...
const EditPoll = () => {
  ...
  const pollData = useSelector((state) => state.pollSlice.allPolls).filter(
    (p) => p._id == params.id
  );
  ...
  const uploadFile = () => {
    if (image === null) {
      ...
      const storageRef = ref(
        storage,
        "images/" + "image-" + Date.now() + Math.round(Math.random() * 1e9)
      );
        ...
        <Box sx={{ maxWidth: "100%" }}>
          <FormikProvider value={formik}>
            ...
            >
              ...
              <Typography
                component="div"
                sx={{ display: "flex", margin: "4px 0", alignItems: "center" }}
              >
                <Input
                  id="image"
                  name="image"
              ...
              <FieldArray
                ...
                render={(arrayHelpers) => (
                  <>
                    ...
                    <Typography component="div" variant="p" mb={1} mt={3}>
                      Add Option
                      <Fab
                        sx={{
                          margin: "0 4px",
              ...
              <Box mt={5}>
                <Button
                  ...
                  type="submit"
                  color="success"
                  sx={{ marginRight: "0.8rem", textTransform: "none" }}
                >
                  Update
                </Button>
              </Box>
